...
class RealTimePlotNode(Node):
    def __init__(self):
        ...
        self.speed_left_sub = self.create_subscription(
            Float32, 'speed_left', self.speed_left_callback, 10)
        self.speed_right_sub = self.create_subscription(
            Float32, 'speed_right', self.speed_right_callback, 10)
